...
export const themes = {
  classic: {
    ...
    roleDefault: 'text-slate-500',
    roleOwner: 'text-red-500',
    roleModerator: 'text-amber-500',
    roleBlue: 'text-blue-500',
    rolePurple: 'text-purple-500',
    roleTeal: 'text-teal-500',
    roleGreen: 'text-emerald-500',
    rolePink: 'text-pink-500',
    roleIndigo: 'text-indigo-500',
    roleOrange: 'text-orange-500',
